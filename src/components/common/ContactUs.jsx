...
const ContactUs = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    // No need to initialize EmailJS here - that happens automatically when importing the library
  }, []);
        ...
        <div className={themeClasses.form}>
          ...
          <form ref={form} onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              ...
              {/* This hidden input field will contain the recipient email
              <input 
                type="hidden" 
                name="to_email" 
                value="foodibuddiegapp@gmail.com" 
              /> */}
            </div>
...
//   useEffect(() => {
//     window.scrollTo(0, 0);
//     emailjs.init(import.meta.env.PUBLIC_KEY); // Replace with your actual public key
//   }, []);
...
//     subject: "",
//     message: "",
//     to_email: "foodibuddiegapp@gmail.com", // Add recipient email
//   });
...
//         templateParams,
//         import.meta.env.PUBLIC_ID// Replace with your EmailJS public key
//       );
...
//         subject: "",
//         message: "",
//         to_email: "foodibuddiegapp@gmail.com",
//       });
//     } catch (error) {
//       console.error("Error sending email:", error);
//       setStatus({
